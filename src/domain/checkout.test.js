...
describe("Checkout without pricing rules", () => {
  test("should be able to add a product", () => {
    const checkout = new Checkout();
    checkout.scan("TSHIRT");
    expect(checkout.numberOfItems()).toBe(1);
  });

  test("should be able to increment the quantity of a product", () => {
    const checkout = new Checkout();
    checkout.scan("TSHIRT");
  ...
  test("should be able to decrement the quantity of a product", () => {
    const checkout = new Checkout();
    checkout.scan("TSHIRT");
  ...
  test("should be able to calculete the amount of all the products", () => {
    const checkout = new Checkout();
    checkout.scan("TSHIRT");
    checkout.scan("TSHIRT");
    checkout.scan("TSHIRT");
...
describe("Checkout without pricing rules", () => {
  ...
  test("Bulk discounts: (for TSHIRT items). Buying 3 or more of this product, the price per unit is reduced by 5%", () => {
    checkout.scan("TSHIRT");
    checkout.scan("TSHIRT");
    checkout.scan("TSHIRT");
  ...
  test("2-for-1 promotions: (for MUG items). Buy two of them, get one free. ", () => {
    checkout.decrement("TSHIRT");
    checkout.scan("MUG");
    checkout.scan("MUG");
  ...
  test("should be able to calculete the total without buying a multiple of two ", () => {
